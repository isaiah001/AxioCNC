...
1. **Download and install the package**
   ...
   ```bash
   curl -L -o axiocnc-headless_0.0.86_amd64.deb https://github.com/rsteckler/AxioCNC/releases/download/v0.0.86/axiocnc-headless_0.0.86_amd64.deb
   sudo dpkg -i axiocnc-headless_0.0.86_amd64.deb

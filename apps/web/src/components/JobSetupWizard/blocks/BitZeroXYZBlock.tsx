...
export function BitZeroXYZBlock({ methods, context, onComplete, onError, debugAllowNext, footerLeftExtra, footerRightExtra }: SetupBlockProps) {
  ...
  const runProbe = useCallback(async () => {
    ...
    const xyzMacroLines = [
      ...
      '',
      '; X-Axis Probing',
      appendProbeInput(`G38.2 X${xyProbeDistance} F${xyProbeFeedrateA}`, xyMethod.probeInput),
      'G0 X-2',
      appendProbeInput(`G38.2 X5 F${probeFeedrateB}`, xyMethod.probeInput),
      'G90',
      '%X_RIGHT=posx',
      'G91',
      ...
      appendProbeInput(`G38.2 X-${xyProbeDistance} F${xyProbeFeedrateA}`, xyMethod.probeInput),
      'G0 X2',
      appendProbeInput(`G38.2 X-5 F${probeFeedrateB}`, xyMethod.probeInput),
      'G90',
      '%X_LEFT=posx',
      '',
      ...
      '; Y-Axis Probing',
      'G91',
      appendProbeInput(`G38.2 Y${xyProbeDistance} F${xyProbeFeedrateA}`, xyMethod.probeInput),
      'G0 Y-2',
      appendProbeInput(`G38.2 Y5 F${probeFeedrateB}`, xyMethod.probeInput),
      'G90',
      '%Y_TOP=posy',
      'G91',
      ...
      appendProbeInput(`G38.2 Y-${xyProbeDistance} F${xyProbeFeedrateA}`, xyMethod.probeInput),
      'G0 Y2',
      appendProbeInput(`G38.2 Y-5 F${probeFeedrateB}`, xyMethod.probeInput),
      'G90',
      '%Y_BTM=posy',
      '',
      '%Y_CHORD=Y_TOP-Y_BTM',
      ...
      '',
      '; Z-Axis Probing',
      appendProbeInput(`G38.2 Z-${zProbeDistance} F${zProbeFeedrateA}`, zMethod.probeInput),
      'G0 Z2',
      appendProbeInput(`G38.2 Z-5 F${probeFeedrateB}`, zMethod.probeInput),
      setZZeroCommand,
      `G0 Z${zFinal}`,
      '',
